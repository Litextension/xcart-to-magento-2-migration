...
=== X-Cart to Magento 2.x Migration Tool ===
Version: 2.4.1
Developed by: LitExtension
Download: https://litextension.com/magento-2-x-migration/xcart-to-magento-2-migration.html 


== Description ==
LitExtension X-Cart to Magento 2.x Migration Tool allows you to migrate your products, orders, customers, passwords and other data from X-Cart to Magento 2.x automatically.
